...
**Team Name:** Ez 4.0
**Github:** https://github.com/UTSCCSCC01/project-ez4-0/ 
...
## Product Backlog PB.md (Max 8 marks) 
  - Sufficient stories created to occupy team for release 1 (max 2 marks) 
    ...
    Your mark: 1
    Feedback: Minimum of 20 user stories required
  ...
  - Relevant persona clearly identified for each user story (max 2 marks) 
    ...
    Your mark: 1
    Feedback: Some peronas are a bit vague. What do you mean by *user*?
...
## Documentation: README.md (max 3 marks)
  ...
  - Installation for your Software/System
    ...
    Your mark: 0
    Feedback: No preliminary installation process is given. Even though your team has not started development, some preliminary installation info can be provided such as Stack version prerequisite, setting up (ie. cloning the repo etc.)
  ...
  Feedback: Make sure you put the README.md file on your root directory (outside of docs)
...
## User experience: (max 4 marks)
  ...
  Feedback: Great work on your UX designs
