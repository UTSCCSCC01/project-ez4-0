...
## User Stories (Tracked in Jira) (max 10 marks) 
  ...
  - Clearly Defined Acceptance Criteria (max 2 marks)
    ...
    - 0 marks = the majority of the Sprint2 stories do not have clearly defined or testable acceptance criteria

    Your Mark: 0 

  User Stories Total Mark: 6 / 10

  Commnet: No acceptance criteria provided on jira; tasks are not being properly prioritized in Jira
...
Comment: EZ40-47, EZ40-57, EZ40-58, EZ40-48, EZ40-52 are not having pull request and dedicated branch
...
- Working software: 2 (max 2 marks)
- **Tues:** 2 features
...
- Dashboard
- Post feeds/search
- Job posts (Does not fully work) -1
