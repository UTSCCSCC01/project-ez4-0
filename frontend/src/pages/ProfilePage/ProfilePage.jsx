import Crayon from "../../img/Crayon.jpg";
                          ...
                          <div className="text-gray-700">
                              <div className="grid md:grid-cols-2 text-sm">
                                  ...
                                  <div className="grid grid-cols-2">
                                      ...
                                      <div className="px-4 py-2">+1 6479940022</div>
                                  </div>
                                  <div className="grid grid-cols-2">
                                      <div className="px-4 py-2 font-semibold">Current Address</div>
                                      <div className="px-4 py-2">Toronto, On, Scarborough</div>
                                  </div>
                                  <div className="grid grid-cols-2">
                                      <div className="px-4 py-2 font-semibold">Permanant Address</div>
                                      <div className="px-4 py-2">Toronto, On, Pickering</div>
                                  </div>
                                  <div className="grid grid-cols-2">
                      ...
                      <div className="bg-white p-3 shadow-sm rounded-sm">
                          ...
                          <div className="grid grid-cols-2">
                              ...
                              <div>
                                  ...
                                  <ul className="list-inside space-y-2">
                                      <li>
                                          <div className="text-indigo-600">Masters Degree in University of Toronto</div>
                                          <div className="text-gray-500 text-xs">September 2017 - 2021 May</div>
                                      </li>
                                      <li>
                                          <div className="text-indigo-600">Bachelors Degreen in UBC</div>
                                          <div className="text-gray-500 text-xs">May 2021 - Now</div>
                                      </li>
                                  </ul>
                              </div>
                          </div>
